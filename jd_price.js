...
async function siteppM_skuOnceApply() {
  ...
  let bodyinfo = { sid: "", type: "25", forcebot: "", token: $.token, feSt: $.token ? "s" : "f" }
  let options = {
    url: `${JD_API_HOST}api?appid=siteppM&functionId=siteppM_skuOnceApply&forcebot=&t=${time}`,
    body: `body=${encodeURIComponent(JSON.stringify(bodyinfo))}&h5st=20220119233553895%3B8621779130589798%3Bd2f64%3Btk02wb1da1c9918nCeKA4uoDxjxpex7C91qFTMvXiG1Se7aLT0fgRXvcrcMzC8Nrjv%2BM2k0nCxJV9MBkRgrWqOVuvdRF%3B70229d494a2017f85ed11acd44be7d78fce2b913c4909ee5b0bc628966341e42%3B3.0%3B1642606553895`,
    headers: {
      "Host": "api.m.jd.com",
